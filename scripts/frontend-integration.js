 ...
 * This file demonstrates how to integrate Questtorch with a web frontend
 */

// For React/Vue/Angular applications
export class QuesttorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuesttorchClient(provider, contractAddress);
